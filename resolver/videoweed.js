...
function resolve(link)
{
  	try
  	{
	    ...
	    var params = {cid:1, cid3:"bitvid.sx", cid2:"undefined", pass:"undefined", file:file, key:filekey, numOfErrors:0, user:"undefined"};
   		var apiResponse = showtime.httpReq("http://www.bitvid.sx/api/player.api.php", {headers:head,args:params, noFollow:true,compression:true});
